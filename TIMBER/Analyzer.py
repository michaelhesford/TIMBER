...
cpp_args =  '-x c++ -c --std=c++11 -I %s/include %s -lstdc++ -l correctionlib -Wl,-rpath,/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/py3-correctionlib/2.1.0-bc1f1a24613552be911056d8eb959866/lib/python3.9/site-packages/correctionlib/lib/'%(rootpath,libs)
